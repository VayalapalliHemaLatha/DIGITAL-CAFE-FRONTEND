...
function OrderDetailPage({ onAuthChange }) {
  const { id } = useParams();
        ...
        <div className="container py-4">
          <nav className="mb-2">
            <ol className="breadcrumb mb-0">
              ...
              <li className="breadcrumb-item"><Link to="/orders" className="text-primary">My Orders</Link></li>
        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <div className="auth-card p-4 p-lg-5">
              ...
              {order.orderDate && <p><strong>Date:</strong> {order.orderDate} {order.orderTime}</p>}
